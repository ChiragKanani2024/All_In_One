...
const validate = ()=>{
    ...
    let expval= false;
    let work_experience_detail = document.querySelectorAll(".work_experience_detail");
    ...
    // }
        ...
        if (isvalidate) {
            ...
            if (hindi.checked != true && gujarati.checked != true && english.checked != true) {
              isvalidate = false;
              lang_alert.innerText  = "Atleast one language required"
               ...
               if(hindi.checked == true){
                ...
                if (hindi_read.checked != true && hindi_speak.checked != true && hindi_write.checked != true) {
                    isvalidate = false;
                    lang_alert.innerText  = "Atleast one language opration required for hindi"
                }
               }
               ...
               if(english.checked == true){
                ...
                if (english_read.checked != true && english_speak.checked != true && english_write.checked != true) {
                    isvalidate = false;
                    lang_alert.innerText  = "Atleast one language opration required for english"
                }
               }
               ...
               if(gujarati.checked == true){
                ...
                if (gujarati_read.checked != true && gujarati_speak.checked != true && gujarati_write.checked != true) {
                    isvalidate = false;
                    lang_alert.innerText  = "Atleast one language opration required for gujarati"
                }
               }
...
if (location.pathname == "/job_application/insertform" || location.pathname == "/job_application/insertform2") {
...
if (window.location.pathname == '/job_application/insertform2' || location.pathname == "/job_application/updateform2") {
...
submit_button.addEventListener("click",async (e)=>{
    ...
    if (validate2(count)) {
        ...
        if (window.location.pathname == '/job_application/insertform2') {
            let result = await fetch('http://localhost:3000/job_application/insertdata2',{
                method: "POST",
                headers: {
            ...
            if (window.location.pathname == '/job_application/updateform2') {
                let result = await fetch('http://localhost:3000/job_application/ajaxupdatedata',{
                    method: "POST",
                    headers: {
                        'Content-Type': ' application/x-www-form-urlencoded',
                        'xml':"hello"
